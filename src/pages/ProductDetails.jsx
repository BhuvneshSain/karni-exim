        ...
        <div className="flex flex-col md:grid md:grid-cols-2 gap-8 mt-6">          <motion.div 
          ...
          >
            {product.isBestSeller && (
              <div className="inline-block bg-yellow-400 text-yellow-800 text-xs font-semibold px-3 py-1 rounded-full mb-2 w-fit">
                Bestseller
              </div>
            )}
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-4 pt-4 border-t border-gray-200">
              <motion.a
                ...
                className="w-full sm:w-auto text-center bg-green-600 hover:bg-green-700 text-white font-semibold px-5 py-3 rounded shadow transition flex items-center justify-center gap-2"
              >
              ...
              <motion.a
                ...
                className="w-full sm:w-auto text-center border-2 border-blue-600 text-blue-600 hover:bg-blue-50 font-semibold px-5 py-3 rounded shadow-sm transition flex items-center justify-center gap-2"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {relatedProducts.map((relatedProduct, index) => (
                ...
                >
                  ...
                  <div className="p-4">
                    <h3 className="font-semibold text-lg mb-1 text-blue-900 truncate">{relatedProduct.name}</h3>
